...
#line 154 "src/y.tab.c" /* yacc.c:358  */
...
{
  "$end", "error", "$undefined", "inteiro", "palavra", "string",
  "virgula", "abre", "fecha", "EOL", "$accept", "linha", "list",
  "conteudo", "element", YY_NULLPTR
};
#endif
